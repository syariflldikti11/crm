...
catatan validator :<?= $a->catatan; ?>
                   ...
                   <?php if($a->status_iku==3):  ?><font color="green">valid</font>
                    ...
                    <a data-tooltip="tooltip"
                      ...
                      title="Bukti Dukung" href="javascript:;"
                  ...
                  onclick="return confirm('anda yakin ingin menghapus data ini')"
                   href="<?php echo base_url('pj/delete_iku7/'.$a->id_iku7.'/'.$d->id_iku);?>" 
                  ...
                  onclick="return confirm('anda yakin ingin mengirimkan data iku ini ?')"
                   href="<?php echo base_url('pj/send_iku7/'.$a->id_iku7.'/'.$d->id_iku);?>" 
 ...
 <div
    ...
    echo form_open('pj/simpan_iku7','id="sample_form"'); ?>
 ...
 <div
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open_multipart('pj/update_iku7'); ?>
                   
                  
                   <input type="hidden" name="id_iku7" id="id" required class="form-control">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="hidden" name="old_file" id="file" required class="form-control">
                            ...
                            <div class="modal-footer">
                            <input type="submit" name="submit"  class="btn btn-info btn-pill" value="Upload">
                              <button
                                type="button"
                                class="btn btn-danger btn-pill"
                                data-bs-dismiss="modal">
...
<script>
 ...
 $(document).ready(function(){
  ...
  $('#sample_form').on('submit', function(event){
   ...
   {
    $.ajax({
     url:"<?php echo site_url('pj/simpan_iku7')?>",
     method:"POST",
     data:$(this).serialize(),
     beforeSend:function()
     {
...
window.location.href="<?php echo base_url('pj/iku7/'); ?>"+document.getElementById('id_iku').value;
    setTimeout(function(){
