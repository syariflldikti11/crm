          ...
          <h4 class="card-title mb-0">   
             <?php if($status_cek!=3):?>  <a   data-bs-toggle="modal"
                        data-bs-target="#bs-example-modal-md" href="#" class="btn btn-info btn-sm"> Tambah</a><?php endif; ?>
                           <a href="<?php echo base_url('pj/usulan_tb');?>"  class="btn btn-dark btn-sm"> kembali</a></h4> </h4> 
        </div>
        <div class="card-body">
...
catatan validator :<?= $d->catatan; ?>
             ...
             <a  data-tooltip="tooltip"
                  ...
                  onclick="return confirm('anda yakin ingin menghapus data ini')"
                   href="<?php echo base_url('pj/delete_detail_usulan_tb/'.$d->id_detail_usulan_tb.'/'.$d->id_usulan_tb);?>" 
                    ><i class="fa fa-trash"></i></a>
                     <a  data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Kirim" 
                  onclick="return confirm('anda yakin ingin mengirim data ini')"
                   href="<?php echo base_url('pj/kirim_detail_usulan_tb/'.$d->id_detail_usulan_tb.'/'.$d->id_usulan_tb);?>" 
                  ...
                  <a  data-tooltip="tooltip"
                   ...
                   href="<?php echo base_url('pj/histori_detail_usulan_tb/'.$d->id_detail_usulan_tb);?>" 
...
<div
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            <div class="modal-header d-flex align-items-center">
                              ...
                              Tambah Detail Usulan Program Kerja Tahun Berjalan
                              </h4>
                              <button
                                type="button"
                                class="btn-close"
    ...
    echo form_open_multipart('pj/simpan_detail_usulan_tb'); ?>
                      <div class="modal-body">
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                           ...
                           Edit Usulan Proker Tahun Berjalan
                             ...
                             <?php  
             echo validation_errors();                       
    echo form_open_multipart('pj/update_detail_usulan_tb'); ?>
                            <div class="modal-body">
