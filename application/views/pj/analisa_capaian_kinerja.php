      ...
      <div class="card">
        <div class="border-bottom title-part-padding">
          <h4 class="card-title mb-0">
            <?php if($this->session->userdata('akses')!='3') :?><a   data-bs-toggle="modal"
                        data-bs-target="#bs-example-modal-md" href="#" class="btn btn-info btn-sm"> Tambah</a><?php endif;?>
                      
                          <a href="<?php echo base_url('pj/analisa');?>"  class="btn btn-dark btn-sm"> kembali</a></h4>  </h4> 
        </div>
        <div class="card-body">
...
$d->status_analisa==3):  ?><font color="green">valid</font>
                  ...
                  <td align="center"><div align="center">
                    <?php if(
$d->status_analisa==0 or  $d->status_analisa ==2) :?><a  data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Delete" 
                  onclick="return confirm('anda yakin ingin menghapus data ini')"
                   href="<?php echo base_url('pj/delete_analisa_capaian_kinerja/'.$d->id_analisa.'/'.$id_iku);?>" 
                    ><i class="fa fa-trash"></i></a> <a data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Edit" href=""
                           data-bs-toggle="modal" data-bs-target="#modaledit<?= $d->id_analisa ?>"   
                    ...
                    <a  data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Kirim" 
                  onclick="return confirm('anda yakin ingin mengirimkan analisa iku ini ?')"
                   href="<?php echo base_url('pj/kirim_analisa/'.$d->id_analisa.'/'.$id_iku);?>" 
