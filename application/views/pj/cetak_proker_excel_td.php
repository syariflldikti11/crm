...
header("Content-Disposition: attachment; filename=Data Proker Tahun Berjalan.xls"); { ?>
  <?php 
...
<center><h5>DAFTAR PROGRAM KERJA LEMBAGA LAYANAN PENDIDIKAN TINGGI WILAYAH XI TAHUN <?= $tahun+1; ?></h5></center>
<p />
