...
catatan validator :<?= $a->catatan; ?>
                  ...
                  onclick="return confirm('anda yakin ingin menghapus data ini')"
                   href="<?php echo base_url('pj/delete_iku8/'.$a->id_iku8.'/'.$d->id_iku);?>" 
                    ...
                    <a data-tooltip="tooltip"
                      ...
                      title="Edit" href="javascript:;"
                           data-bs-toggle="modal" data-bs-target="#bs-edit-data"   
                              data-id="<?= $a->id_iku8 ?>"
                              data-jumlah_dosen="<?= $a->jumlah_dosen ?>"
                              data-jumlah_dosen_tridharma="<?= $a->jumlah_dosen_tridharma ?>"
                              > 
                    <i class="fa fa-edit"></i> </a> <a  data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Kirim" 
                  onclick="return confirm('anda yakin ingin mengirimkan data iku ini ?')"
                   href="<?php echo base_url('pj/send_iku8/'.$a->id_iku8.'/'.$d->id_iku);?>" 
                    ><i class="fa fa-paper-plane"></i></a></div> <?php endif; ?> </td> <?php endif; ?>
                </tr>
               <?php endforeach; ?>
              </tbody>
            </table>
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="overflow:hidden;">
 <a href="<?= base_url();?>template/Template tridharma.xlsx">Download Template</a>
                         <?php  
             echo validation_errors();                       
    echo form_open_multipart('pj/upload_bukti_dukung'); ?>
                 ...
                 <input type="hidden" name="menu" value="iku8" required >
...
$jsArrayy .= "prdNamee['" . $b->kode_pt . "'] = {opt_kodept:'" . addslashes($b->kode_pt) . "',opt_namapt:'".addslashes($b->nama_pt)."',opt_jmldosen:'".addslashes($b->jumlah_dosen)."'};\n";
...
<div class="mb-3">
                      ...
                      <input type="text" name="jumlah_dosen"  class="form-control" id="opt_jmldosen" >  
</div> 
<div class="mb-3">
                        <label for="exampleInputEmail1">Jumlah Dosen Bertridharma diluar kampus</label>
                      <input type="text" name="jumlah_dosen_tridharma"  class="form-control" id="jml_dosen_tr" required>  
</div>
<div class="mb-3">
                        <label for="exampleInputEmail1">Triwulan</label>
                       <select class="form-select"  name="id_triwulan">
 ...
 <div
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open('pj/update_iku8'); ?>
                   
                   <div class="mb-3">
                   <input type="hidden" name="id_iku8" id="id" required class="form-control">
                        <label for="exampleInputEmail1">Jumlah Dosen</label>
                        <input type="text" name="jumlah_dosen" id="jumlah_dosen" required class="form-control">
                        <input type="hidden" name="id_iku" value="<?= $d->id_iku; ?>" required class="form-control">
                        
                      </div>
                      <div class="mb-3">
                        <label for="exampleInputEmail1">Jumlah Dosen Bertridharma diluar kampus</label>
                        <input type="text" name="jumlah_dosen_tridharma" id="jumlah_dosen_tridharma" required class="form-control">
