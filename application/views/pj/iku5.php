...
<div
    ...
    echo form_open('pj/simpan_iku5','id="sample_form"'); ?>
...
<script>
 ...
 $(document).ready(function(){
  ...
  $('#sample_form').on('submit', function(event){
   ...
   {
    $.ajax({
     url:"<?php echo site_url('pj/simpan_iku5')?>",
     method:"POST",
     data:$(this).serialize(),
     beforeSend:function()
     {
...
window.location.href="<?php echo base_url('pj/iku5/'); ?>"+document.getElementById('id_iku').value;
    setTimeout(function(){
