      ...
      <div class="card">
        <div class="border-bottom title-part-padding">
          <h4 class="card-title mb-0">
           Cetak
                <a target="_blank" href="<?php echo base_url('pj/cetak_proker_td');?>" > <i class="fa fa-file-pdf"></i></a>
                <a target="_blank" href="<?php echo base_url('pj/cetak_proker_excel_td');?>" ><i class="fa fa-file-excel"></i>   
               </h4> 
        </div>
        <div class="card-body">
 ...
 echo rupiah($anggaran);?></td>
                  <td align="center"><div align="center">   
                    ...
                    <a  data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Detail Usulan" 
                   href="<?php echo base_url('pj/detail_proker_td/'.$d->id_usulan_tb);?>" 
