 ...
 ?>
             ...
             <a  data-tooltip="tooltip"
                  ...
                  onclick="return confirm('anda yakin ingin menghapus data ini')"
                   href="<?php echo base_url('pj/delete_usulan_tb/'.$d->id_usulan_tb);?>" 
                    ><i class="fa fa-trash"></i></a> 
 <a  data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Kirim" 
                  onclick="return confirm('anda yakin ingin mengirim usulan ini')"
                   href="<?php echo base_url('pj/kirim_usulan_tb/'.$d->id_usulan_tb);?>" 
                    ><i class="fa fa-paper-plane"></i></a>
                  <?php endif; ?>
                    <a  data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Detail Usulan" 
                   href="<?php echo base_url('pj/detail_usulan_tb/'.$d->id_usulan_tb);?>" 
...
<div
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            <div class="modal-header d-flex align-items-center">
                              ...
                              Tambah Usulan Program Kerja Tahun Berjalan
                              </h4>
                              <button
                                type="button"
                                class="btn-close"
    ...
    echo form_open_multipart('pj/simpan_usulan_tb'); ?>
                       <div class="mb-3">
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                           ...
                           Edit Usulan Proker Tahun Berjalan
                             ...
                             <?php  
             echo validation_errors();                       
    echo form_open_multipart('pj/update_usulan_tb'); ?>
                            <div class="modal-body">
