...
catatan validator :<?= $b->catatan; ?>
                   ...
                   <?php if($b->status_iku==3):  ?><font color="green">valid</font>
                    <?php endif; ?></div></td>
                      ...
                      <?php if($this->session->userdata('jenis')<>'2' ) :?> <td><div align="center"><?php if($b->status_iku ==0 or $b->status_iku ==2 ):  ?> <a  data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Delete" 
                  onclick="return confirm('anda yakin ingin menghapus data ini')"
                   href="<?php echo base_url('pj/delete_iku10/'.$b->id_iku10.'/'.$d->id_iku);?>" 
                    ><i class="fa fa-trash"></i></a> <a data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Edit" href="javascript:;"
                           data-bs-toggle="modal" data-bs-target="#bs-edit-data"   
                              data-id="<?= $b->id_iku10 ?>"
                              data-predikat_sakip="<?= $b->predikat_sakip ?>"
                  ...
                  onclick="return confirm('anda yakin ingin mengirimkan data iku ini ?')"
                   href="<?php echo base_url('pj/send_iku10/'.$b->id_iku10.'/'.$d->id_iku);?>" 
...
<div
    ...
    echo form_open_multipart('pj/upload_bukti_dukung'); ?>
                 ...
                 <input type="hidden" name="menu" value="iku10" required >
...
<div
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open_multipart('pj/simpan_iku10'); ?>
                   
                
                
                
                <div class="mb-3">
                        <label for="exampleInputEmail1">Predikat Sakip</label>
                        <input type="text" name="predikat_sakip" required class="form-control">
                        <input type="hidden" name="id_iku" value="<?= $d->id_iku; ?>" required class="form-control">
                      </div>
                      <div class="mb-3">
                        <label for="exampleInputEmail1">Triwulan</label>
                      ...
                      <div class="mb-3">
                        <label for="exampleInputEmail1">File Predikat SAKIP</label>
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open('pj/update_iku10'); ?>
                   
                   <div class="mb-3">
                   <input type="hidden" name="id_iku10" id="id" required class="form-control">
                        <label for="exampleInputEmail1">Predikat Sakip</label>
                        <input type="text" name="predikat_sakip" id="predikat_sakip" required class="form-control">
                        <input type="hidden" name="id_iku" value="<?= $d->id_iku; ?>" required class="form-control">
    ...
    $(document).ready(function() {
        ...
        $('#bs-edit-data').on('show.bs.modal', function (event) {
            ...
            modal.find('#predikat_sakip').attr("value",div.data('predikat_sakip'));
