                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                      ...
                      <div class="pcoded-navigatio-lavel">Manajemen Pelanggan</div>
                        <ul class="pcoded-item pcoded-left-item">
                                 <li class="">
                                    <a href="<?php echo base_url ('pegawai/pelanggan'); ?>">
