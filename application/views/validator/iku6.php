...
catatan validator :<?= $a->catatan; ?>
                  ...
                  <td align="center">
                    <?php if($a->status_iku !=0):  ?><a data-tooltip="tooltip"
                      ...
                      title="Validasi" href=""
                           data-bs-toggle="modal" data-bs-target="#modalvalidasi<?= $a->id_iku6 ?>"   
...
<?php
                ...
                foreach ($dt_iku6 as $g): ?>

                       <div
                        id="modalvalidasi<?= $g->id_iku6 ?>"
                        class="modal fade"
                        tabindex="-1"
    ...
    echo form_open('validator/validasi_iku6'); ?>
                            <div class="modal-body">

                      
                    <input type="hidden" class="form-control" name="id_iku6" value="<?= $g->id_iku6; ?>">
 ...
 <div
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open('validator/valid_iku6'); ?>
