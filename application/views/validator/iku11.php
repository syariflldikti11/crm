...
catatan validator :<?= $b->catatan; ?>
                   ...
                   <?php if($b->status_iku !=0):  ?> <a data-tooltip="tooltip"
                      ...
                      title="Validasi" href=""
                           data-bs-toggle="modal" data-bs-target="#modalvalidasi<?= $b->id_iku11 ?>"   
...
<?php
                ...
                foreach ($dt_iku11 as $g): ?>

                       <div
                        id="modalvalidasi<?= $g->id_iku11 ?>"
                        class="modal fade"
                        tabindex="-1"
    ...
    echo form_open('validator/validasi_iku11'); ?>
                            <div class="modal-body">

                      
                    <input type="hidden" class="form-control" name="id_iku11" value="<?= $g->id_iku11; ?>">
 ...
 <div
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open('validator/valid_iku11'); ?>
