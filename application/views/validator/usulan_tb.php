            ...
            <div class="col-md-5 align-self-center">
              ...
              <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                  ...
                  Usulan Program Kerja Tahun Berjalan
                    </li>
    ...
    <div class="col-12">
      <div class="card">
        <div class="border-bottom title-part-padding">
          ...
          Cetak
                <a target="_blank" href="<?php echo base_url('validator/cetak_usulan_proker');?>" > <i class="fa fa-file-pdf"></i></a>
                <a target="_blank" href="<?php echo base_url('validator/cetak_usulan_proker_excel');?>" ><i class="fa fa-file-excel"></i></a> 
             </h4> 
        </div>
        <div class="card-body">
...
$valid=$cek_valid->valid; 
 ?>
                  ...
                  <td ><div align="center"> <a target="_blank" data-tooltip="tooltip"
                      ...
                      title="KAK" 
                   href="<?php echo base_url('validator/view_kak/'.$d->id_usulan_tb);?>"><i class="fa fa-file-pdf"></i></a></div></td>
                    <td ><div align="center"> <a target="_blank" data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="RAB" 
                   href="<?php echo base_url('validator/view_rab/'.$d->id_usulan_tb);?>"><i class="fa fa-file-pdf"></i></a> <a target="_blank" data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="RAB Excel" 
                   href="<?php echo base_url('validator/view_rab_excel/'.$d->id_usulan_tb);?>"><i class="fa fa-file-excel"></i></a></div></td>
                  <td><?= $d->nama_iku; ?></td>
 ...
 <a  data-tooltip="tooltip"
                  ...
                  onclick="return confirm('anda yakin ingin mengirim usulan ini')"
                   href="<?php echo base_url('validator/buka_usulan_tb/'.$d->id_usulan_tb);?>" 
                    ><i class="fa fa-lock"></i></a>
                     <a data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Validasi Usulan" onclick="return confirm('anda yakin ingin memvalidasi usulan ini')"
                   href="<?php echo base_url('validator/validasi_usulan_tb/'.$d->id_usulan_tb);?>"
                              > 
                    <i class="fa fa-check"></i> </a>
                                      <a  data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Detail Usulan" 
                   href="<?php echo base_url('validator/detail_usulan_tb/'.$d->id_usulan_tb);?>" 
