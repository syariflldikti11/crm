...
catatan validator :<?= $a->catatan; ?>
                  ...
                  <a  data-tooltip="tooltip"
                   ...
                   href="<?php echo base_url('validator/detail_iku4/'.$a->id_iku4);?>" 
                    ><i class="fa fa-list"></i></a> </div> 
                <?php if($a->status_iku !=0):  ?> <a data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Validasi" href=""
                           data-bs-toggle="modal" data-bs-target="#modalvalidasi<?= $a->id_iku4 ?>"   
...
<?php
    ...
    echo form_open('validator/validasi_iku4'); ?>
 ...
 <div
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open('validator/valid_iku4'); ?>
   ...
   <div
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open('validator/kirim_iku4'); ?>
...
<div
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open_multipart('validator/simpan_iku4'); ?>
...
<div class="mb-3">
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open_multipart('validator/update_iku4'); ?>
