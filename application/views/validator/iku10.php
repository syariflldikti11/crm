...
catatan validator :<?= $b->catatan; ?>
                  ...
                  <td><div align="center">
                <?php if($b->status_iku !=0):  ?>   <a data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Validasi" href=""
                           data-bs-toggle="modal" data-bs-target="#modalvalidasi<?= $b->id_iku10 ?>"   
...
<?php
                ...
                foreach ($dt_iku10 as $g): ?>

                       <div
                        id="modalvalidasi<?= $g->id_iku10 ?>"
                        class="modal fade"
                        tabindex="-1"
    ...
    echo form_open('validator/validasi_iku10'); ?>
                            <div class="modal-body">

                      
                    <input type="hidden" class="form-control" name="id_iku10" value="<?= $g->id_iku10; ?>">
 ...
 <div
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open('validator/valid_iku10'); ?>
