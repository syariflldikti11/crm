      ...
      <div class="card">
        <div class="border-bottom title-part-padding">
          <h4 class="card-title mb-0">
                          ...
                          <a href="<?php echo base_url('validator/analisa');?>"  class="btn btn-dark btn-sm"> kembali</a></h4>  </h4> 
        </div>
        <div class="card-body">
...
$d->status_analisa==3):  ?><font color="green">valid</font>
                  ...
                  <td align="center">
                   ...
                   <a data-tooltip="tooltip"
                      ...
                      title="Validasi" href=""
                           data-bs-toggle="modal" data-bs-target="#modalvalidasi<?= $d->id_analisa ?>"   
  ...
  <?php
    ...
    echo form_open('validator/update_analisa_capaian_kinerja'); ?>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                           ...
                           Validasi Analisa Capaian Kinerja
                             ...
                             <?php  
             echo validation_errors();                       
    echo form_open('validator/validasi_analisa_capaian_kinerja'); ?>
                            <div class="modal-body">

                      
                    <input type="hidden" class="form-control" name="id_analisa" value="<?= $g->id_analisa; ?>">
                    <input type="hidden" name="id_iku" value="<?= $id_iku; ?>" required>
                     <div class="mb-3">
