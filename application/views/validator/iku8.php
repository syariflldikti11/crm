...
catatan validator :<?= $a->catatan; ?>
                   ...
                   <?php if($a->status_iku==3):  ?><font color="green">valid</font>
                    <?php endif; ?></div></td>
                  <td align="center">  <?php if($a->status_iku !=0):  ?> <a data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Validasi" href=""
                           data-bs-toggle="modal" data-bs-target="#modalvalidasi<?= $a->id_iku8 ?>"   
...
<?php
                ...
                foreach ($dt_iku8 as $g): ?>

                       <div
                        id="modalvalidasi<?= $g->id_iku8 ?>"
                        class="modal fade"
                        tabindex="-1"
    ...
    echo form_open('validator/validasi_iku8'); ?>
                            <div class="modal-body">

                      
                    <input type="hidden" class="form-control" name="id_iku8" value="<?= $g->id_iku8; ?>">
 ...
 <div
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open('validator/valid_iku8'); ?>
