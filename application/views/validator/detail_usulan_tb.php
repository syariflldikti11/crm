      ...
      <div class="card">
        <div class="border-bottom title-part-padding">
          <h4 class="card-title mb-0">   
                           ...
                           <a href="<?php echo base_url('validator/usulan_tb');?>"  class="btn btn-dark btn-sm"> kembali</a></h4> </h4> 
        </div>
        <div class="card-body">
...
catatan validator :<?= $d->catatan; ?>
                 ...
                 <?php if($d->status_detail_usulan !=0):  ?><a data-tooltip="tooltip"
                  ...
                  <a  data-tooltip="tooltip"
                   ...
                   href="<?php echo base_url('validator/histori_detail_usulan_tb/'.$d->id_detail_usulan_tb);?>" 
...
<?php
    ...
    echo form_open('validator/validasi_detail_usulan_tb'); ?>
