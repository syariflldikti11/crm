    ...
    <div class="col-12">
      <div class="card">
        <div class="border-bottom title-part-padding">
          ...
          Cetak
                <a target="_blank" href="<?php echo base_url('validator/cetak_usulan_proker_td');?>" > <i class="fa fa-file-pdf"></i></a>
                <a target="_blank" href="<?php echo base_url('validator/cetak_usulan_proker_excel_td');?>" ><i class="fa fa-file-excel"></i></a> 
             </h4> 
        </div>
        <div class="card-body">
...
$valid=$cek_valid->valid; 
 ...
 <a  data-tooltip="tooltip"
                  ...
                  onclick="return confirm('anda yakin ingin mengirim usulan ini')"
                   href="<?php echo base_url('validator/buka_usulan_td/'.$d->id_usulan_tb);?>" 
                    ><i class="fa fa-lock"></i></a>
                     <a data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Validasi Usulan" onclick="return confirm('anda yakin ingin memvalidasi usulan ini')"
                   href="<?php echo base_url('validator/validasi_usulan_td/'.$d->id_usulan_tb);?>"
                              > 
                    <i class="fa fa-check"></i> </a>
                                      <a  data-tooltip="tooltip"
                      data-bs-placement="top"
                      title="Detail Usulan" 
                   href="<?php echo base_url('validator/detail_usulan_td/'.$d->id_usulan_tb);?>" 
