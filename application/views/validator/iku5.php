        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            ...
            <thead class="bg-info text-white">
              ...
              <tbody>
              <?php
              $no=1; foreach ($dt_iku as $a) :?>
                <tr>
                  <td> <div align="center"> <?= $no++; ?></div></td>
                  <td><div align="center"><?= $a->tw; ?></div></td>
                  <td><div align="center"><?= $a->nama_pt; ?></div></td>
                  <td><div align="center"><?= $a->nm_jenj_didik; ?></div></td>
                  <td><div align="center"><?= $a->nm_pd; ?></div></td>
                  <td><div align="center"><?= $a->nipd; ?></div></td>
                  <td><div align="center"><?= $sks=$a->sks_smt; ?></div></td>
                
                  <td><div align="center"><?= $a->bobot; ?></div></td>
...
<div
    ...
    echo form_open('validator/validasi_iku5'); ?>
                            <div class="modal-body">

                      
                    <input type="hidden" class="form-control" name="id_iku5" id="id" >
 ...
 <div
                      ...
                      >
                        <div class="modal-dialog modal-lg">
                         ...
                         <?php  
             echo validation_errors();                       
    echo form_open('validator/valid_iku5'); ?>
