    ...
    <div class="col-12">
      <div class="card">
        <div class="border-bottom title-part-padding">
          ...
          Cetak
                <a target="_blank" href="<?php echo base_url('pimpinan/cetak_usulan_proker');?>" > <i class="fa fa-file-pdf"></i></a>
                <a target="_blank" href="<?php echo base_url('pimpinan/cetak_usulan_proker_excel');?>" ><i class="fa fa-file-excel"></i></a> 
             </h4> 
        </div>
        <div class="card-body">
 ...
 ?>
              ...
              <td><?php if($d->status_usulan==0):  ?><font color="red">Belum Dikirim</font>
                  ...
                  <td align="center"><div align="center">   
                      ...
                      data-bs-placement="top"
                      title="Detail Usulan" 
                   href="<?php echo base_url('pimpinan/detail_usulan_tb/'.$d->id_usulan_tb);?>" 
