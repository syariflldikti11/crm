      ...
      <div class="card">
        <div class="border-bottom title-part-padding">
          <h4 class="card-title mb-0">   
                           ...
                           <a href="<?php echo base_url('pimpinan/usulan_td');?>"  class="btn btn-dark btn-sm"> kembali</a></h4> </h4> 
        </div>
        <div class="card-body">
...
catatan validator :<?= $d->catatan; ?>
                  ...
                  <a  data-tooltip="tooltip"
                   ...
                   href="<?php echo base_url('pimpinan/histori_detail_usulan_td/'.$d->id_detail_usulan_tb);?>" 
