...
Validator 
              ...
              <!--<li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    <a   href="<?= base_url('pimpinan/standar_layanan'); ?>" class="sidebar-link"
                  ...
                  <?php endif; ?>
                  <li class="sidebar-item">
                    <a   href="<?= base_url('pimpinan/pts'); ?>" class="sidebar-link"
                      ><i class="mdi mdi-view-quilt"></i
                      ><span class="hide-menu"> PTS </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a  href="<?= base_url('pimpinan/prodi'); ?>" class="sidebar-link"
                      ><i class="mdi mdi-view-parallel"></i
                      ><span class="hide-menu"> Prodi </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a  href="<?= base_url('pimpinan/dosen'); ?>" class="sidebar-link"
                      ><i class="mdi mdi-view-parallel"></i
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a  href="<?= base_url('pimpinan/target_kinerja'); ?>" class="sidebar-link"
                      ><i class="mdi mdi-view-quilt"></i
                      ><span class="hide-menu"> Target kinerja </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a  href="<?= base_url('pimpinan/renaksi'); ?>" class="sidebar-link"
                      ><i class="mdi mdi-view-parallel"></i
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  ...
                  <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse second-level">
                      <li class="sidebar-item">
                        <a href="<?= base_url('pimpinan/usulan_tb'); ?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> Tahun Berjalan  <span class="badge badge-pill bg-success"><?= $prokertb; ?></span></span></a>
                      </li>
                      <li class="sidebar-item">
                        <a href="<?= base_url('pimpinan/usulan_td'); ?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> Tahun Depan  <span class="badge badge-pill bg-success"><?= $prokertd; ?></span></span></a>
                      </li>
                   ...
                   <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse second-level">
                      <li class="sidebar-item">
                        <a href="<?= base_url('pimpinan/proker_tb'); ?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> Tahun Berjalan</span></a>
                      </li>
                      <li class="sidebar-item">
                        <a href="<?= base_url('pimpinan/proker_td'); ?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> Tahun Depan</span></a>
                      </li>
                  ...
                  <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse second-level">
                      <li class="sidebar-item">
                        <a href="<?= base_url('pimpinan/kalender_proker_tb'); ?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> Tahun Berjalan</span></a>
                      </li>
                      <li class="sidebar-item">
                        <a href="<?= base_url('pimpinan/kalender_proker_td'); ?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> Tahun Depan</span></a>
                      </li>
