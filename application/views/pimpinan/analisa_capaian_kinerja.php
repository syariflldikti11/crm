      ...
      <div class="card">
        <div class="border-bottom title-part-padding">
          <h4 class="card-title mb-0">
                          ...
                          <a href="<?php echo base_url('pimpinan/analisa');?>"  class="btn btn-dark btn-sm"> kembali</a></h4>  </h4> 
        </div>
        <div class="card-body">
...
$d->status_analisa==3):  ?><font color="green">valid</font>
  ...
  <?php
    ...
    echo form_open('pimpinan/update_analisa_capaian_kinerja'); ?>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                           ...
                           Validasi Analisa Capaian Kinerja
                             ...
                             <?php  
             echo validation_errors();                       
    echo form_open('pimpinan/validasi_analisa_capaian_kinerja'); ?>
                            <div class="modal-body">
