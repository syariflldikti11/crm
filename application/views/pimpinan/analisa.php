...
<div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
            <a   href="<?= base_url('pimpinan/cetak_analisa'); ?>" class="btn btn-dark btn-sm"> Cetak</a>
          ...
          <div class="table-responsive">
            ...
            <thead class="bg-info text-white">
              ...
              <tbody>
               ...
               <?php $id_iku=$d->id_iku; ?>
                  <td><a href="<?php echo base_url('pimpinan/analisa_capaian_kinerja/'.$d->id_iku);?>"><?= $d->iku; ?></a></td>
