                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class="">
                                        <a href="<?= base_url(); ?>\files\extra-pages\landingpage\index.htm" target="_blank" data-i18n="nav.landing-page.main"> <span class="pcoded-micon"><i class="ti-mobile"></i></span> <span class="pcoded-mtext">Landing Page</span> <span class="pcoded-mcaret"></span> </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="pcoded-hasmenu">
                                    ...
                                    <li class="pcoded-hasmenu ">
                                        ...
                                        <ul class="pcoded-submenu">
                                            ...
                                            <li class="pcoded-hasmenu ">
                                                ...
                                                <ul class="pcoded-submenu">
                                                    <li class="">
                                                        <a href="<?= base_url(); ?>\files\extra-pages\email-templates\email-welcome.htm" data-i18n="nav.email.email-template.welcome-email">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    ...
                                                    <li class="">
                                                        <a href="<?= base_url(); ?>\files\extra-pages\email-templates\email-password.htm" data-i18n="nav.email.email-template.reset-password">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    ...
                                                    <li class="">
                                                        <a href="<?= base_url(); ?>\files\extra-pages\email-templates\email-newsletter.htm" data-i18n="nav.email.email-template.newsletter-email">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    ...
                                                    <li class="">
                                                        <a href="<?= base_url(); ?>\files\extra-pages\email-templates\email-launch.htm" data-i18n="nav.email.email-template.app-launch">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    ...
                                                    <li class="">
                                                        <a href="<?= base_url(); ?>\files\extra-pages\email-templates\email-activation.htm" data-i18n="nav.email.email-template.activation-code">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
