...
<body>
            ...
            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                    ...
                    <div class="pcoded-navigatio-lavel">Manajemen Penjualan</div>
                     <ul class="pcoded-item pcoded-left-item">
                                 <li class="">
                                    <a href="<?php echo base_url ('supervisor/penawaran'); ?>">
                      ...
                      <ul class="pcoded-item pcoded-left-item">
                                 <li class="">
                                    <a href="<?php echo base_url ('supervisor/pesanan'); ?>">
                      ...
                      <div class="pcoded-navigatio-lavel">Manajemen Pelanggan</div>
                        <ul class="pcoded-item pcoded-left-item">
                                 <li class="">
                                    <a href="<?php echo base_url ('supervisor/pelanggan'); ?>">
                       ...
                       <ul class="pcoded-item pcoded-left-item">
                        ...
                        <a href="<?php echo base_url ('supervisor/kasus'); ?>">
                          ...
                          <div class="pcoded-navigatio-lavel">Manajemen Laporan</div>
                                <ul class="pcoded-item pcoded-left-item">
                                     <li class="">
                        <a href="<?php echo base_url ('supervisor/laporan_pelanggan'); ?>">
    ...
    echo form_open('supervisor/laporan_konsultasi'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('supervisor/laporan_kasus'); ?>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Dari</label>
                        <input type="date" name="dari" class="form-control">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('supervisor/laporan_event'); ?>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Dari</label>
                        <input type="date" name="dari" class="form-control">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('supervisor/laporan_pesanan'); ?>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Dari</label>
                        <input type="date" name="dari" class="form-control">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('supervisor/laporan_penawaran'); ?>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Dari</label>
                        <input type="date" name="dari" class="form-control">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('supervisor/laporan_promo'); ?>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Dari</label>
                        <input type="date" name="dari" class="form-control">
