...
<head>
    <title>CRM-Login Aplikasi </title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                         ...
                         <?php
                     echo form_open('login/auth','class="md-float-material form-material"'); ?>
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <input 
                        class="
                         btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20
                        "
