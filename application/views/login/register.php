    ...
    <section class="login-block">
      ...
      <?php
                     echo form_open('login/save','class="md-float-material form-material"'); ?>
                                ...
                                <div class="form-group form-primary">
                                    <input type="number" name="no_wa" class="form-control" required placeholder="Whatsapp">
                                    <span class="form-bar"></span>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <p class="text-inverse text-left"><a href="<?php echo base_url ('login'); ?>"><b class="f-w-600">Back to login</b></a></p>
                                    </div>
